...
public class EmployeeAddScreen extends javax.swing.JFrame {
    ...
    private void adicionar() {
        String sql = "insert into tb_workers(name_wor, cpf_wor, birth_wor, sex_wor, post_wor, email_wor, phone_wor, adres_wor) values(?,?,?,?,?,?,?, ?)";
        try {
            ...
            if (jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField7.getText().isEmpty() || jTextField6.getText().isEmpty() || jTextField5.getText().isEmpty()) {
                ...
                if (adicionado > 0) {
                    JOptionPane.showMessageDialog(null, "Funcionário adiciondo com sucesso");
                    limpar();
                }
            }
        } catch (Exception e) {
    ...
    public void setarCampos() {
        ...
        jComboBox2.setSelectedItem(jTable1.getModel().getValueAt(setar, 5).toString());
        jTextField1.setText(jTable1.getModel().getValueAt(setar, 6).toString());
        jTextField7.setText(jTable1.getModel().getValueAt(setar, 7).toString());
        jTextField3.setText(jTable1.getModel().getValueAt(setar, 8).toString());

        jButton1.setEnabled(false);
    }

    private void alterar() {
        int confirmacao = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja alterar os dados deste funcionário?", "Atenção", JOptionPane.YES_NO_OPTION);
        if (confirmacao == JOptionPane.YES_OPTION) {
            String sql = "update tb_workers set name_wor=?,cpf_wor=?,birth_wor=?,sex_wor=?, post_wor=?, email_wor=?, phone_wor=?, adres_wor=? where id_wor = ?";
            try {
                pst = conexao.prepareStatement(sql);
                pst.setString(1, jTextField2.getText());
                pst.setString(2, jTextField5.getText());
                ...
                if (jTextField2.getText().isEmpty() || jTextField3.getText().isEmpty() || jTextField7.getText().isEmpty() || jTextField6.getText().isEmpty() || jTextField5.getText().isEmpty()) {
                    ...
                    JOptionPane.showMessageDialog(null, "Selecione o funcionário que deseja alterar os dados!");
                } else {
    ...
    private void remover() {
        int confirmacao = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja remover este funcionário do banco de dados?", "Atenção", JOptionPane.YES_NO_OPTION);
        if (confirmacao == JOptionPane.YES_OPTION) {
            String sql = "delete from tb_workers where id_wor = ?";
            if (jTextField8.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Selecione o funcionário que deseja apagar os dados!");
            } else {
                try {
                    pst = conexao.prepareStatement(sql);
                    ...
                    if (apagado > 0) {
                        JOptionPane.showMessageDialog(null, "Dados do funcionário foram removidos com sucesso");
                        limpar();
                        jButton1.setEnabled(true);
                    }
                } catch (Exception e) {
    ...
    private void limpar() {
        ...
        jComboBox2.setSelectedItem("Atendente");
    }
    ...
    private void initComponents() {
        ...
        setTitle("Software de Controle de Pedidos - Cadastro de Funcionários");
        setResizable(false);
        ...
        jLabel6.setText("<html><body>Sexo:</body></htm>");
        ...
        jLabel13.setText("<html><body><span style=\"color:red;\">*</span>Cargo:</body></htm>");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Atendente", "Vendedor", "Gestor", "TI" }));
        ...
        jLabel11.setText("Pesquisar Funcionários:");
