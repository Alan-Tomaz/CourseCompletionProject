...
public class AboutScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Software de Controle de Pedidos - Sobre");
        setResizable(false);
        ...
        jLabel5.setText("Baseado em:");

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel6.setText("<html><head><style>p{text-align:justify;text-indent:20px;}</style></head><body><ul><li>José de Assis (YouTube) - ☕️ Java MySQL - Sistema Completo</li></ul></body></html>");
